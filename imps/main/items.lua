...
for _ , itemElem in pairs(impElems) do -- This registers all seven aligned foci at once
	minetest.register_craftitem("imps:foci_" .. itemElem, {
	description = "a focus ring infused with the essence of " .. itemElem,
	inventory_image = "imps_foci_" .. itemElem .. ".png",
	groups = {impsfoci = 1},
	stack_max = 1,
	})
end
